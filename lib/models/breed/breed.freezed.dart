...
mixin _$Breed {
  ...
  List<Breed>? get subBreeds => throw _privateConstructorUsedError;
...
abstract class $BreedCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, List<Breed>? subBreeds});
}
...
class _$BreedImpl extends _Breed {
  const _$BreedImpl({required this.name, final List<Breed>? subBreeds})
      : _subBreeds = subBreeds,
        super._();

  @override
  final String name;
  final List<Breed>? _subBreeds;
  @override
  List<Breed>? get subBreeds {
    final value = _subBreeds;
...
abstract class _Breed extends Breed {
  const factory _Breed(
      {required final String name, final List<Breed>? subBreeds}) = _$BreedImpl;
